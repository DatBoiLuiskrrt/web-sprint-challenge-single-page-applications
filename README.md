...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   useroutematch returns a match object that basically contains the information of the current url matched with the path that we provided to our route
1. How would you explain form validation to someone who has never programmed before?
   form validation is basically testing our code by inputting data into our inputs and we make sure that the inputs can actually receive data and do what they're supposed to do
1. In 1-2 sentences, define end to end testing.
   end to end testing is the process of testing an app from beginning to end to ensure that every components behaves as expected.
